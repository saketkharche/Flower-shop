...
import { searchProducts, filterProducts, listProducts } from '../../actions/productActions';
                ...
                <div style={{ marginTop: "120px" }}>
                            ...
                            <div className="mx-4">
                                <form className="form-inline form" onSubmit={handleSearch}>
                                    <div className="form-group mx-sm-3 mb-2">
                                        ...
                                        <input type="text" className="form-control" id="search" name="search" value={search}
                                        onChange={
                                            (e) => setSearch(e.target.value)} placeholder="search" />
                                    </div>
                                    <button type="button" className="btn btn-primary rounded-pill mb-2">Search</button>
                                </form>
                            </div>
                    ...
                    <section className="products" id="products">
                        ...
                        <div className="box-container" >
                            {products.map((ele) => {
                                return (<div className="box" key={ele._id}>
